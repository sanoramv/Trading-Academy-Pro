...
| [`[31.06]`](docs/31_Case_Studies/31.06_May_2022_IndusInd_Bank_Adani_Group_Episodes.md) IndusInd Bank and Adani Group Episodes | `[25.06]`, `[08.08]` | `[27.01]`, `[31.01]`, `[31.05]`, `[24.10]` | `[31.07]` | — | Different businesses under the same parent company are automatically divers... |
